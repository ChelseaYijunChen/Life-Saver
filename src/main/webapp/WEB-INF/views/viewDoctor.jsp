				...
				<table class="table">
				  ...
				  <tbody>
				    <tr>
				      ...
				      <td><c:out value='${doctor.getDepartment().getDepartmentName()}'/></td>    
				      <td><a href="editDoctorForm.html?doctorId=${doctor.doctorId}" class="btn btn-danger">Edit</a></td>
					  <td><a href="deleteDoctor.html?doctorId=${doctor.doctorId}" class="btn btn-danger">Delete</a></td>
				    </tr>
				  </tbody>
				  </c:forEach>
				</table>
