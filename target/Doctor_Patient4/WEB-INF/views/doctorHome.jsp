		...
		<div class="row">
			<div class="col-sm-3 col-md-2 sidebar">
				<ul class="nav nav-sidebar" style="">
					...
					<li><a href="appointmentForm.html" target="iframe_a">Appointment</a></li>
					<li><a href="addScheduleForm.html" target="iframe_a">Schedule</a></li>
					<li><a href="viewAllPatients" target="iframe_a">Patient List</a></li>
