			...
			<div class="row">
				...
				<div class="col-md-10">
					<form:form action="searchPatientByName.html" method="post"
						role="form">
						<h2 class="" style="text-align: center;">Search Patient</h2>
						<div class="form-group row">
							<form:label path="patientName" class="col-sm-3 col-form-label">Patient Name</form:label>
							<div class="col-sm-9">
								<form:input path="patientName" value="${patientName}"
									type="text" class="form-control" name="doctorName"
									placeholder="Joey" />
							</div>
						</div>
						<div class="form-group row">
