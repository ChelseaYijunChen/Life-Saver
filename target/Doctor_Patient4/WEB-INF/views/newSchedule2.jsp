...
<body>
	...
	<div class="container loginSession">
		<div class="jumbotron">
						...
						<div class="form-group row">
							...
							<div class="col-sm-8">
								<input class="form-control"
									placeholder="Doctor ID will be autogenerated" name="doctorId" />
		    ...
		    <label for="exampleSelect1" class="col-sm-2 col-form-label">Begin Hour</label>
		    <div class="col-sm-3">
			    <div class='input-group date' id='begin2'>
				    <input type='text' class="form-control" name="begin2"/>
				        <span class="input-group-addon">
				        	<span class="glyphicon glyphicon-time"></span>
				        </span>
				</div>
		    </div>
		    <label for="exampleSelect1" class="col-sm-2 col-form-label">End Hour</label>
		    <div class="col-sm-3">
...
<script type="text/javascript">
	$(function() {
		...
		$("#departuretime").on("dp.change", function(e) {
			$('#arrivetime').data("DateTimePicker").minDate(e.date);
		});
		$("#arrivetime").on("dp.change", function(e) {
