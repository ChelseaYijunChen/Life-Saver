...
<link href="${pageContext.request.contextPath}/resource/css/style.css"
	rel="stylesheet">
<link
	href="${pageContext.request.contextPath}/resource/css/carousel.css"
	rel="stylesheet">
		...
		<div class="jumbotron">
			<div class="row">
				...
				<div class="col-md-10">
					...
					<form:form action="addOrUpdateDoctor.html" method="post"
						id="loginform1" modelAttribute="doctor">
						<h2 class="" style="text-align: center;">New Or Update Doctor</h2>
						<div class="form-group row">
							<form:label path="doctorName" cssClass="col-sm-3 col-form-label">Full Name</form:label>
							<div class="col-sm-9">
								<form:input path="doctorName" type="text"
									cssClass="form-control" name="fullName" placeholder="Joey" />
							</div>
						</div>
						<div class="form-group row">
